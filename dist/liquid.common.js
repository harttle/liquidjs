            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        paths = roots.map(function (root) { return fs$1.resolve(root, file, _this.options.extname); });
                        _i = 0, paths_1 = paths;
                        _b.label = 1;
                    case 1:
                        if (!(_i < paths_1.length)) return [3 /*break*/, 5];
                        filepath = paths_1[_i];
                        return [4 /*yield*/, fs$1.exists(filepath)];
                    case 2:
                        if (!(_b.sent()))
                            return [3 /*break*/, 4];
                        ...
                        _a = this.parse;
                        return [4 /*yield*/, fs$1.readFile(filepath)];
                    case 3:
