...
function anySeries(iterable, iteratee) {
    ...
    iterable.forEach(function (item, idx) {
        ret = ret.catch(function (e) { return iteratee(item, idx, iterable); });
    });
    return ret;
}
/*
...
function resolve(filepath, root, options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            root = uniq(root);
            paths = root.map(function (root) { return path.resolve(root, filepath); });
            return [2 /*return*/, anySeries(paths, function (path$$1) { return __awaiter(_this, void 0, void 0, function () {
                    var e_1;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, statFileAsync(path$$1)];
                            case 1:
                                _a.sent();
                                return [2 /*return*/, path$$1];
                            case 2:
                                e_1 = _a.sent();
                                e_1.message = e_1.code + ": Failed to lookup " + filepath + " in: " + root;
                                throw e_1;
...
function read(filepath) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, readFileAsync(filepath, 'utf8')];
        });
    });
}
